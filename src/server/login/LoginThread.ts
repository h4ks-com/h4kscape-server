    ...
    switch (type) {
        ...
        case 'player_login': {
            ...
            if (Environment.LOGIN_SERVER) {
                ...
                if (!Environment.NODE_PRODUCTION && username === Environment.HEAD_ADMIN) {
                    response.staffmodlevel = 4; // head admin gets dev powers
                }
                ...
                if (!Environment.NODE_PRODUCTION && username === Environment.HEAD_ADMIN) {
                    staffmodlevel = 4; // head admin gets dev powers
                }
